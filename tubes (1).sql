...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2025 at 07:40 AM
...
INSERT INTO `menu` (`id_menu`, `nama_menu`, `harga_menu`, `jumlah_stock`, `is_aktif`, `created_at`) VALUES
(1, 'Krabby Patty', 25000.00, 150, 1, '2025-12-15 05:30:32'),
(2, 'Krusty Krab Pizza', 45000.00, 80, 1, '2025-12-15 05:30:32'),
(3, 'Krusty Krab Hot Dog', 20000.00, 100, 1, '2025-12-15 05:30:32'),
(4, 'Krusty Shake', 18000.00, 200, 1, '2025-12-15 05:30:32');
...
CREATE TABLE `pembayaran` (
  ...
  `id_transaksi` int(11) NOT NULL,
  `metode_pembayaran` enum('CASH','QRIS','DEBIT','TRANSFER') NOT NULL,
